...
export const AWS_SETTING = {
    accessKey: process.env.AWS_SETTING || "AKIAXLHILBZ4XTB5FWY7",
    regionKey: process.env.AWS_SETTING || "ap-southeast-1",
    secretKey: process.env.AWS_SETTING || "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",
    s3Setting: {
